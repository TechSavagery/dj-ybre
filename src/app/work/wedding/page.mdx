...
export const caseStudy = {
  client: 'Wedding Package',
  title: 'Full Wedding Ceremony + Reception ($1300)',
  description:
    'Unlimited Planning Sessions and Online Event Planner to capture all wedding day details',
  summary: [
    'Unlimited Planning Sessions and Online Event Planner to capture all wedding day details.',
    'Speaker, Mic, and Music Coverage for all Ceremony + Reception Events .',
    'DJ/MC Services to help orchestrate events and create seamless transitions ',
    'Dance Floor Lighting to create the ultimate dance party for you and your guests',
  ],
  logo,
  image: { src: imageHero },
  date: '$1300',
